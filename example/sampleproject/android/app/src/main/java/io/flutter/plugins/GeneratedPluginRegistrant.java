...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.example.ant_media_flutter.AntMediaFlutterPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin ant_media_flutter, com.example.ant_media_flutter.AntMediaFlutterPlugin", e);
    }
    try {
