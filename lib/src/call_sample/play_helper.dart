...
typedef void SignalingStateCallback(PlayHelperState state);
...
class PlayHelper extends Object {
  ...
  void invite(String peerId, String media, useScreen) {
    this.onStateChange(PlayHelperState.CallStateNew);
  ...
  connect() async {
    ...
    _socket?.onOpen = () {
      ...
      this.onStateChange(PlayHelperState.ConnectionOpen);
    ...
    _socket?.onClose = (int code, String reason) {
      ...
      this.onStateChange(PlayHelperState.ConnectionClosed);
    };
  ...
  _closePeerConnection(streamId) {
    ...
    this.onStateChange(PlayHelperState.CallStateBye);
  }
