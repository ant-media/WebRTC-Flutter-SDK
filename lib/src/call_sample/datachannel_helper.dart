...
class DataChannelHelper extends Object {
  ...
  DataChannelHelperStateCallback onStateChange;
  ...
  void invite(String peerId, String media, useScreen) {
    this.onStateChange(DataChannelHelperState.CallStateNew);
  ...
  connect(Function? completion) async {
    var url = '$_host';
    ...
    _socket?.onOpen = () {
      print('onOpen');
      this.onStateChange(DataChannelHelperState.ConnectionOpen);
    ...
    _socket?.onClose = (int code, String reason) {
      ...
      this.onStateChange(DataChannelHelperState.ConnectionClosed);
    };
  ...
  void addDataChannel(id, RTCDataChannel channel) {
  ...
  _closePeerConnection(streamId) {
    ...
    this.onStateChange(DataChannelHelperState.CallStateBye);
  }
