...
typedef void PublishHelperStateCallback(PublishHelperState state);
...
class PublishHelper extends Object {
  MediaStream? _localStream;
  List<MediaStream> _remoteStreams = [];
  PublishHelperStateCallback onStateChange;
  ...
  connect() async {
    ...
    _socket?.onOpen = () {
      print('onOpen');
      this.onStateChange(PublishHelperState.ConnectionOpen);
    ...
    _socket?.onClose = (int code, String reason) {
      ...
      this.onStateChange(PublishHelperState.ConnectionClosed);
    };
  ...
  _closePeerConnection(streamId) {
    ...
    this.onStateChange(PublishHelperState.CallStateBye);
  }
