...
typedef void PeerHelperStateCallback(PeerHelperState state);
...
class PeerHelper extends Object {
  ...
  connect() async {
    ...
    _socket?.onOpen = () {
      print('onOpen');
      this.onStateChange(PeerHelperState.ConnectionOpen);
      join(_streamId);
    ...
    _socket?.onClose = (int code, String reason) {
      ...
      this.onStateChange(PeerHelperState.ConnectionClosed);
    };
  ...
  _closePeerConnection(streamId) {
    ...
    this.onStateChange(PeerHelperState.CallStateBye);
  }
